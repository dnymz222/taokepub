#coding=utf8
from . import api3
from app.utils.constvalue import x_code,x_data,x_hasnext,x_meesage,hefengfishingapikey,hefengusername,holiday_key,workingday_api_key
import json
...
def holidaycountries():
    url = 'https://holidayapi.com/v1/countries?key=' + holiday_key
    list = []
    try:
        ...
        for country in countries:
            ...
            dict["languages"] = country["languages"]
            dict["flag"] =country["flag"]
            list.append(dict)
